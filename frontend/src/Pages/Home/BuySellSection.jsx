        ...
        <div className="flex h-screen mt-10 px-8 gap-8">
            ...
            <div className="flex-1 bg-white p-12 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center relative rounded-2xl
                ...
                <Link 
                    to='/login' 
                    state={{ role: 'buyer' }}
                    className="text-center w-64 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-medium px-8 py-4 rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                >
                    Start Shopping
                </Link>
            ...
            <div className="flex-1 bg-gradient-to-r from-green-500 to-green-600 p-12 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center relative rounded-2xl
                ...
                <Link 
                    to='/login'
                    state={{ role: 'seller' }}
                    className="w-64 bg-white text-green-600 text-center font-medium px-8 py-4 rounded-lg transition-all duration-300 hover:shadow-lg hover:bg-gray-50 hover:-translate-y-1"
                >
                    Start Selling
                </Link>
